    ...
    <div class="main-wrapper main-wrapper-1">
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <a href="peminjaman.php"><img src="perpus_logo.png" alt="logo" width="220"></a>
          </div>
          <div class="sidebar-brand sidebar-brand-sm">
          <a href="peminjaman.php"><img src="p_logo.png" alt="brand" width="48"></a>
          </div>
      ...
      <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Entri Data Peminjaman</h1>
                <div class="section-header-breadcrumb">
                <div class="breadcrumb-item"><a href="#" style="color: grey;">Dashboard</a></div>
              <div class="breadcrumb-item active"><a href="peminjaman.php">Peminjaman</a></div>
                </div>
            </div>
...
if (isset($_POST['submit'])) {
    ...
    $jml_pinjam_buku = $_POST['jml_pinjam_buku'];
    $status_peminjaman = $_POST['status_peminjaman'];


    $query = mysqli_query($koneksi, "INSERT INTO peminjaman(id_buku,id_user,tanggal_peminjaman,tanggal_pengembalian,jml_pinjam_buku,status_peminjaman)
     values ('$id_buku','$id_user','$tanggal_peminjaman','$tanggal_pengembalian','$jml_pinjam_buku','$status_peminjaman')");
...
?>
                      ...
                      <div class="form-group">
                        ...
                        <select name="id_buku" class="form-control" >
                                <?php
                                    ...
                                    while($buku = mysqli_fetch_array($b)){
                                        ?>
                                        <option value = <?php echo $buku['bukuID'];?><?php echo $buku['judul']?> (stok buku : <?php echo $buku['bukuID'];?>) </option>
                                        <?php
                                    }
                                    ?>
                                </select>
                        ...
                        <div class="form-group">
                        <label style="font-size: 13px; font-weight:bold;">Tanggal Pinjam :</label>
                        <input type="date" class="form-control" required="" name="tanggal_peminjaman">
                      </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                        <label style="font-size: 13px; font-weight:bold;">Jumlah Buku :</label>
                        <input type="number" class="form-control" required="" name="jml_pinjam_buku">
                      </div>
                        <div class="form-group">
                        <label style="font-size: 13px; font-weight:bold;">Status Peminjaman :</label>
                        <input type="text" class="form-control" required="" name="status_peminjaman" value="dipinjam">
                      </div>
