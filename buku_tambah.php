    ...
    <div class="main-wrapper main-wrapper-1">
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <a href="buku_tambah.php"><img src="perpus_logo.png" alt="logo" width="220"></a>
          </div>
          <div class="sidebar-brand sidebar-brand-sm">
          <a href="buku_tambah.php"><img src="p_logo.png" alt="brand" width="48"></a>
          </div>
      ...
      <div class="main-content">
        <section class="section">
            <div class="section-header">
              ...
              <div class="breadcrumb-item active"><a href="buku_tambah.php">Tambah Buku</a></div>
                </div>
            </div>
...
if (isset($_POST['id_kategori'])) {
	...
	$query = mysqli_query($koneksi, "INSERT INTO buku(id_kategori,judul,penulis,penerbit,tahun_terbit,jml_buku)
     VALUES('$id_kategori','$judul','$penulis','$penerbit','$tahun_terbit','$jml_buku')");
...
?>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" required="" name="tahun_terbit">
                      </div>
                      <div class="form-group">
                        <label style="font-size: 13px; font-weight:bold;">Stok buku :</label>
                        <input type="text" class="form-control" required="" name="jml_buku">
                      </div>
                    </div>
