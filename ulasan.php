    ...
    <div class="main-wrapper main-wrapper-1">
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <a href="index.php"><img src="perpus_logo.png" alt="logo" width="220"></a>
          </div>
          <div class="sidebar-brand sidebar-brand-sm">
          <a href="ulasan.php"><img src="p_logo.png" alt="brand" width="48"></a>
          </div>
...
?>
      ...
      <div class="main-content">
        <section class="section">
            <div class="section-header">
              ...
              <div class="breadcrumb-item active"><a href="ulasan.php">Ulasan</a></div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <body style="font-weight: bold; font-size:16px;">
                                <?php
						$i =1;
						...
						while ($data = mysqli_fetch_array($query)) {
							...
							<tr>
                                ...
                                <td>
									...
									<a href="ulasan_hapus.php?id=<?php echo $data['id_ulasan'];?>" class="btn btn-danger"><i class="fa fa-trash"></i> </a>
  ...
  <script src="ass  ets/modules/popper.js"></script>
