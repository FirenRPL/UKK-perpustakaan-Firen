    ...
    <div class="main-wrapper main-wrapper-1">
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <a href="buku.php"><img src="perpus_logo.png" alt="logo" width="220"></a>
          </div>
          <div class="sidebar-brand sidebar-brand-sm">
          <a href="buku.php"><img src="p_logo.png" alt="brand" width="48"></a>
          </div>
      ...
      <div class="main-content">
        <section class="section">
            <div class="section-header">
              ...
              <div class="breadcrumb-item active"><a href="buku.php">Buku</a></div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                    <a href="buku_tambah.php" class="btn btn-primary" style="font-weight: bold;"><i class="fa fa-plus"></i> Tambah data</a> <br><br>
                        ...
                        <th style="color: white;">Tahun terbit</th>
                        ...
                        <th style="color: white;">Aksi</th>
                            ...
                            <tbody style="font-weight: bold; font-size:15px;">
                                <?php 
                        $i =1;
                        $koneksi = mysqli_query($koneksi, "SELECT*FROM buku LEFT JOIN kategoribuku on buku.kategoriID=kategoribuku.kategoriID");
                        while ($data = mysqli($koneksi)) {
                            ?>
                            <tr>
                                <td><?php echo $i;?></td>
                                ...
                                <td>
                                    <a href="buku_ubah.php?id=<?php echo $data['id_buku'];?>" class="btn btn-info" ><i class="fa fa-edit"></i> Ubah</a>
                                    <a href="buku_hapus.php?id=<?php echo $data['id_buku'];?>" class="btn btn-danger"><i class="fa fa-trash"></i> Hapus</a>
                                </td>
                            </tr>
                            <?php
                            $i++;
