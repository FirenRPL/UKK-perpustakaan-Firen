      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="history.php"><img src="perpus_logo.png" alt="logo" width="220"></a>
          </div>
          <div class="sidebar-brand sidebar-brand-sm">
          <a href="history.php"><img src="p_logo.png" alt="brand" width="48"></a>
          </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="laporan.php" target="_blank" class="btn btn-success" style="font-weight: bold;"><i class="fa fa-print"></i> Generate Laporan</a><br><br>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    if($data['status_peminjaman'] != 'dikembalikan') {
                                        ?>
                                    <a href="history_ubah.php?id=<?php echo $data['id_peminjaman'];?>" class="btn btn-info"><i class="fa fa-edit"></i></a>
                                    <?php
                                }
                                ?>
                                </td>
