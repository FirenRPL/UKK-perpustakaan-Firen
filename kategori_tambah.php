    ...
    <div class="main-wrapper main-wrapper-1">
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <a href="kategori_tambah.php"><img src="perpus_logo.png" alt="logo" width="220"></a>
          </div>
          <div class="sidebar-brand sidebar-brand-sm">
          <a href="kategori_tambah.php"><img src="p_logo.png" alt="brand" width="48"></a>
          </div>
      ...
      <div class="main-content">
        <section class="section">
            <div class="section-header">
              ...
              <div class="breadcrumb-item active"><a href="kategori_tambah.php">Tambah Kategori</a></div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                    <a href="kategori.php" class="btn btn-primary" style="font-weight: bold;">Kembali</a> <br><br>
                    <?php
if (isset($_POST['nama_kategori'])) {
	
	$nama_kategori = $_POST['nama_kategori'];

	$query = mysqli_query($koneksi, "INSERT INTO kategori_buku(nama_kategori) 
