    ...
    <div class="main-wrapper main-wrapper-1">
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <a href="buku_ubah.php"><img src="perpus_logo.png" alt="logo" width="220"></a>
          </div>
          <div class="sidebar-brand sidebar-brand-sm">
          <a href="buku_ubah.php"><img src="p_logo.png" alt="brand" width="48"></a>
          </div>
      ...
      <div class="main-content">
        <section class="section">
            <div class="section-header">
              ...
              <div class="breadcrumb-item active"><a href="buku_ubah.php">Ubah Buku</a></div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                    <a href="buku.php" class="btn btn-primary" style="font-weight: bold;">Kembali</a> <br><br>
 <?php
$id = $_GET['id'];
if (isset($_POST['id_kategori'])) {
	...
	$query = mysqli_query($koneksi, "UPDATE buku SET id_kategori='$id_kategori', judul='$judul', penulis='$penulis', penerbit='$penerbit', tahun_terbit='$tahun_terbit', jml_buku='$jml_buku'
    WHERE id_buku=$id");
...
$query = mysqli_query($koneksi, "SELECT*FROM buku left join kategori_buku on kategori_buku.id_kategori WHERE id_buku=$id");
...
?>
                      ...
                      <div class="form-group">
                        <label style="font-size: 13px; font-weight:bold;">Nama Kategori :</label>
                      ...
                      <div class="form-group">
                        <label style="font-size: 13px; font-weight:bold;">Judul :</label>
                        <input type="text" class="form-control" name="judul" value="<?php echo $data['judul']; ?>" >
                      </div>
                     
                      <div class="form-group">
                        <label style="font-size: 13px; font-weight:bold;">Penulis :</label>
                        <input type="text" class="form-control" name="penulis" value="<?php echo $data['penulis']; ?>" >
                      </div>
                     
                      <div class="form-group">
                        <label style="font-size: 13px; font-weight:bold;">Penerbit :</label>
                        <input type="text" class="form-control" name="penerbit" value="<?php echo $data['penerbit']; ?>" >
                      </div>
                     
                      <div class="form-group">
                        <label style="font-size: 13px; font-weight:bold;">Tahun terbit :</label>
                        <input type="text" class="form-control" name="tahun_terbit" value="<?php echo $data['tahun_terbit']; ?>" >
                      </div>
                     
                      <div class="form-group">
                        <label style="font-size: 13px; font-weight:bold;">Stok buku :</label>
                        <input type="text" class="form-control" name="jml_buku" value="<?php echo $data['jml_buku']; ?>" >
                      </div>
