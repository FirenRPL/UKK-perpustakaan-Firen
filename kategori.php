    ...
    <div class="main-wrapper main-wrapper-1">
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <a href="kategori.php"><img src="perpus_logo.png" alt="logo" width="220"></a>
          </div>
          <div class="sidebar-brand sidebar-brand-sm">
          <a href="kategori.php"><img src="p_logo.png" alt="brand" width="48"></a>
          </div>
      ...
      <div class="main-content">
        <section class="section">
            <div class="section-header">
              ...
              <div class="breadcrumb-item active"><a href="kategori.php">Kategori</a></div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                    <a href="kategori_tambah.php" class="btn btn-primary" style="font-weight: bold;"><i class="fa fa-plus"></i> Tambah data</a> <br><br>
              ...
              ?>
                ...
                <td>
									<a href="kategori_ubah.php?id=<?php echo $data['id_kategori'];?>" class="btn btn-info"><i class="fa fa-edit"></i> Ubah</a>
									<a href="kategori_hapus.php?id=<?php echo $data['id_kategori'];?>" class="btn btn-danger"><i class="fa fa-trash"></i> Hapus</a>
								</td>
								                <td></td>
							</tr>
							<?php
