    ...
    <div class="main-wrapper main-wrapper-1">
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <a href="history_ubah.php"><img src="perpus_logo.png" alt="logo" width="220"></a>
          </div>
          <div class="sidebar-brand sidebar-brand-sm">
          <a href="history_ubah.php"><img src="p_logo.png" alt="brand" width="48"></a>
          </div>
      ...
      <div class="main-content">
        <section class="section">
            <div class="section-header">
              ...
              <div class="breadcrumb-item active"><a href="history_ubah.php">Ubah Kategori</a></div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                    <a href="history.php" class="btn btn-primary" style="font-weight: bold;">Kembali</a> <br><br>
                    <?php
$id = $_GET['id'];
if (isset($_POST['status_peminjaman'])) {
	$tanggal_pengembalian = $_POST['tanggal_pengembalian'];
	$status_peminjaman = $_POST['status_peminjaman'];
	$query = mysqli_query($koneksi, "UPDATE peminjaman SET tanggal_pengembalian='$tanggal_pengembalian' , status_peminjaman='$status_peminjaman'  WHERE id_peminjaman=$id");
	if ($query) {
...
left join buku on buku.id_buku = peminjaman.id_user WHERE id_peminjaman=$id");
...
?>
                      ...
                      <div class="form-group">
                        <label style="font-size: 13px; font-weight:bold;">Nama Peminjam : <?php echo $data['nama_lengkap']; ?></label>
                      </div>
                      <div class="form-group">
                        <label style="font-size: 13px; font-weight:bold;">Buku : <?php echo $data['judul']; ?></label>
                      </div>
                      <div class="form-group">
                        <label style="font-size: 13px; font-weight:bold;">Jumlah Buku : <?php echo $data['jml_buku'];?></label>
                      </div>
                      <div class="form-group">
                        <label style="font-size: 13px; font-weight:bold;">Tanggal Pinjam : <?php echo $data['tanggal_peminjaman'];?></label>
                      </div>
                      <div class="form-group">
                        <label style="font-size: 13px; font-weight:bold;">Tanggal Pengembalian :</label>
                        <input class="form-control" value="<?php echo $data['tanggal_pengembalian'];?>" type="date" name="tanggal_pengembalian">
                      </div>
                      <div class="form-group">
                        <label style="font-size: 13px; font-weight:bold;">Status Pengembalian :</label>
